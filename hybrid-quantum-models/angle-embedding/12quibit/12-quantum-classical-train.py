# ==============================
# QUANTUM U-NET DCGAN FOR DENOISING
# ==============================
import os, json
import torch
...
class Generator(nn.Module):
    def __init__(self):
        ...
        # Quantum bottleneck
        self.qb = QuantumBottleneck(512, 12, 3)
...
def train():
    ...
    save_dir   = os.path.join(base_dir, "quantum_ckpt")
    result_dir = os.path.join(base_dir, "quantum_results")
    ...
    optG = optim.Adam(netG.parameters(), lr=1e-4, betas=(0.5,0.999))
