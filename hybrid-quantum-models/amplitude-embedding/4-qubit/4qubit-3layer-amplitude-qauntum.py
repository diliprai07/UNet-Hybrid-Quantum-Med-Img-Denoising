...
# ========================
# QUANTUM BOTTLENECK WITH AMPLITUDE EMBEDDING (4 QUBITS)
# ========================
class QuantumBottleneck(nn.Module):
    def __init__(self, in_channels=512, n_qubits=4, n_layers=3):
        super().__init__()
        self.n_qubits = n_qubits
        self.n_features = 2 ** n_qubits  # Amplitude embedding needs 2^n_qubits features (16 for 4 qubits)
...
class Generator(nn.Module):
    def __init__(self):
        ...
        # Quantum bottleneck with amplitude embedding (4 qubits -> 16 features)
        self.qb = QuantumBottleneck(512, 4, 3)
...
def train():
    ...
    print("Starting training with Amplitude Embedding (4 Qubits)...")
