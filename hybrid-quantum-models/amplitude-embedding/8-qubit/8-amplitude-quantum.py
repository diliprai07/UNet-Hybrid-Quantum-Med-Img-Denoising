...
# ========================
# QUANTUM BOTTLENECK WITH AMPLITUDE EMBEDDING (8 QUBITS)
# ========================
class QuantumBottleneck(nn.Module):
    def __init__(self, in_channels=512, n_qubits=8, n_layers=3):
        super().__init__()
        self.n_qubits = n_qubits
        self.n_features = 2 ** n_qubits  # Amplitude embedding needs 2^n_qubits features
...
class Generator(nn.Module):
    def __init__(self):
        ...
        # Quantum bottleneck with amplitude embedding (8 qubits -> 256 features)
...
def train():
    ...
    save_dir   = os.path.join(base_dir, "amplitude_quantum_ckpt")  # Different name to compare
    result_dir = os.path.join(base_dir, "amplitude_quantum_results")
    ...
    print("Starting training with Amplitude Embedding...")
